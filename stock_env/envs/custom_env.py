...
class CustomEnv(gym.Env):
    ...
    def __init__(self, train_data, eval_data, len_obs=20, len_window=100, init_balance=1000):
        ...
        self.action_space = spaces.Discrete(5)  # (-40%, -10%, 0, 10%, 40%), (% amount to buy if positive)
    ...
    def result(self, days_per_year=252):  # TODO mock up data 만들기
    ...
    def render(self, ep, close=False): # TODO
