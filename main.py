...
def get_performance(env, agent, train_data=True, training=False, batch_size=12, overlap=20):
    ...
    while not done:
        action = agent.get_action(state, use_random=True)  # action: 0 ~ 4
...
if __name__ == '__main__':
    ...
    parser.add_argument('-name_file_data', default='BHD.csv', type=str)
    parser.add_argument('-name_project', default='BHD_batch', type=str)
    ...
    train_data, test_data = get_data(f'data/{args.name_file_data}')  # 70% of train_data, 30% of test_data
